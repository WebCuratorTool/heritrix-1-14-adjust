...
cp -v /c/AppDev/maven-repo/com/sleepycat/je/3.3.62/je-3.3.62.jar ~/.maven/repository/com.sleepycat/jars
...
cp -v /c/AppDev/maven-repo/com/lowagie/itext/1.2.3/itext-1.2.3.jar ~/.maven/repository/com.lowagie/jars
...
cp -v /c/AppDev/maven-repo/commons-cli/commons-cli/1.0/commons-cli-1.0.jar ~/.maven/repository/commons-cli/jars
...
cp -v /c/AppDev/maven-repo/commons-collections/commons-collections/3.1/commons-collections-3.1.jar ~/.maven/repository/commons-collections/jars
...
cp -v /c/AppDev/maven-repo/commons-codec/commons-codec/1.3/commons-codec-1.3.jar ~/.maven/repository/commons-codec/jars
...
cp -v /c/AppDev/maven-repo/commons-io/commons-io/1.3.1/commons-io-1.3.1.jar ~/.maven/repository/commons-io/jars
...
cp -v /c/AppDev/maven-repo/commons-lang/commons-lang/2.3/commons-lang-2.3.jar ~/.maven/repository/commons-lang/jars
...
cp -v /c/AppDev/maven-repo/commons-logging/commons-logging/1.0.4/commons-logging-1.0.4.jar ~/.maven/repository/commons-logging/jars
...
cp -v /c/AppDev/maven-repo/commons-net/commons-net/1.4.1/commons-net-1.4.1.jar ~/.maven/repository/commons-net/jars
...
cp -v /c/AppDev/maven-repo/dnsjava/dnsjava/2.0.6/dnsjava-2.0.6.jar ~/.maven/repository/dnsjava/jars
...
cp -v /c/AppDev/maven-repo/fastutil/fastutil/5.0.9/fastutil-5.0.9.jar ~/.maven/repository/fastutil/jars
...
cp -v /c/AppDev/maven-repo/it/unimi/dsi/mg4j/2.0.1/mg4j-2.0.1.jar ~/.maven/repository/it.unimi.dsi/jars
...
cp -v /c/AppDev/maven-repo/com/anotherbigidea/javaswf/CVS-SNAPSHOT-1/javaswf-CVS-SNAPSHOT-1.jar ~/.maven/repository/com.anotherbigidea/jars
...
cp -v /c/AppDev/maven-repo/junit/junit/3.8.2/junit-3.8.2.jar ~/.maven/repository/junit/jars
...
cp -v /c/AppDev/maven-repo/net/htmlparser/jericho/jericho-html/2.6.1/jericho-html-2.6.1.jar ~/.maven/repository/net.htmlparser.jericho/jars
...
cp -v /c/AppDev/maven-repo/org/apache/ant/ant/1.7.1/ant-1.7.1.jar ~/.maven/repository/org.apache.ant/jars
...
cp -v /c/AppDev/maven-repo/org/apache/mahout/jets3t/jets3t/0.6.1/jets3t-0.6.1.jar ~/.maven/repository/org.apache.mahout.jets3t/jars
...
cp -v /c/AppDev/maven-repo/org/beanshell/bsh/2.0b4/bsh-2.0b4.jar ~/.maven/repository/org.beanshell/jars
...
cp -v /c/AppDev/maven-repo/org/gnu/inet/libidn/0.6.5/libidn-0.6.5.jar ~/.maven/repository/org.gnu.inet/jars
...
cp -v /c/AppDev/maven-repo/org/mortbay/jetty/jetty/4.2.12/jetty-4.2.12.jar ~/.maven/repository/org.mortbay.jetty/jars
...
cp -v /c/AppDev/maven-repo/poi/poi/2.0-final-20040126/poi-2.0-final-20040126.jar ~/.maven/repository/poi/jars
...
mkdir -pv ~/.maven/repository/poi/jars
cp -v /c/AppDev/maven-repo/poi/poi-scratchpad/2.0-final-20040126/poi-scratchpad-2.0-final-20040126.jar ~/.maven/repository/poi/jars
...
cp -v /c/AppDev/maven-repo/tomcat/jasper-compiler/4.1.30/jasper-compiler-4.1.30.jar ~/.maven/repository/tomcat/jars
...
mkdir -pv ~/.maven/repository/tomcat/jars
cp -v /c/AppDev/maven-repo/tomcat/servlet/4.1.36/servlet-4.1.36.jar ~/.maven/repository/tomcat/jars
...
mkdir -pv ~/.maven/repository/tomcat/jars
cp -v /c/AppDev/maven-repo/tomcat/jasper-runtime/4.1.36/jasper-runtime-4.1.36.jar ~/.maven/repository/tomcat/jars
...
cp -v /c/AppDev/maven-repo/ant/ant-commons-net/1.6.5/ant-commons-net-1.6.5.jar ~/.maven/repository/ant/jars
...
cp -v /c/AppDev/maven-repo/antlr/antlr/2.7.6/antlr-2.7.6.jar ~/.maven/repository/antlr/jars
...
cp -v /c/AppDev/maven-repo/asm/asm/3.0/asm-3.0.jar ~/.maven/repository/asm/jars
...
cp -v /c/AppDev/maven-repo/avalon-framework/avalon-framework/4.1.5/avalon-framework-4.1.5.jar ~/.maven/repository/avalon-framework/jars
...
cp -v /c/AppDev/maven-repo/backport-util-concurrent/backport-util-concurrent/3.0/backport-util-concurrent-3.0.jar ~/.maven/repository/backport-util-concurrent/jars
...
filePath=/c/AppDev/maven-repo/batik/batik/1.5/batik-1.5.jar
...
cp -v /c/AppDev/maven-repo/batik/batik/1.5-fop-0.20-5/batik-1.5-fop-0.20-5.jar ~/.maven/repository/batik/jars
...
cp -v /c/AppDev/maven-repo/com/jcraft/jsch/0.1.27/jsch-0.1.27.jar ~/.maven/repository/com.jcraft/jars
...
cp -v /c/AppDev/maven-repo/commons-beanutils/commons-beanutils/1.6.1/commons-beanutils-1.6.1.jar ~/.maven/repository/commons-beanutils/jars
...
mkdir -pv ~/.maven/repository/commons-codec/jars
cp -v /c/AppDev/maven-repo/commons-codec/commons-codec/1.2/commons-codec-1.2.jar ~/.maven/repository/commons-codec/jars
cp -v /c/AppDev/maven-repo/commons-codec/commons-codec/1.3/commons-codec-1.3.jar ~/.maven/repository/commons-codec/jars
# add commons-codec-1.3 to ~/.maven/cache/maven-artifact-plugin-1.9.1/lib/
mkdir -pv  ~/.maven/cache/maven-artifact-plugin-1.9.1/lib/
cp -v /c/AppDev/maven-repo/commons-codec/commons-codec/1.3/commons-codec-1.3.jar ~/.maven/cache/maven-artifact-plugin-1.9.1/lib/
...
mkdir -pv ~/.maven/repository/commons-collections/jars
cp -v /c/AppDev/maven-repo/commons-collections/commons-collections/3.0/commons-collections-3.0.jar ~/.maven/repository/commons-collections/jars
...
cp -v /c/AppDev/maven-repo/commons-grant/commons-grant/1.0-beta-4/commons-grant-1.0-beta-4.jar ~/.maven/repository/commons-grant/jars
...
cp -v /c/AppDev/maven-repo/commons-httpclient/commons-httpclient/3.0/commons-httpclient-3.0.jar ~/.maven/repository/commons-httpclient/jars
...
cp -v /c/AppDev/maven-repo/commons-jelly/commons-jelly/1.0-RC1/commons-jelly-1.0-RC1.jar ~/.maven/repository/commons-jelly/jars
...
mkdir -pv ~/.maven/repository/commons-jelly/jars
cp -v /c/AppDev/maven-repo/commons-jelly/commons-jelly-tags-ant/1.1/commons-jelly-tags-ant-1.1.jar ~/.maven/repository/commons-jelly/jars
cp -v /c/AppDev/maven-repo/commons-jelly/commons-jelly-tags-antlr/1.0/commons-jelly-tags-antlr-1.0.jar ~/.maven/repository/commons-jelly/jars
cp -v /c/AppDev/maven-repo/commons-jelly/commons-jelly-tags-fmt/1.0/commons-jelly-tags-fmt-1.0.jar ~/.maven/repository/commons-jelly/jars
cp -v /c/AppDev/maven-repo/commons-jelly/commons-jelly-tags-html/1.0/commons-jelly-tags-html-1.0.jar ~/.maven/repository/commons-jelly/jars
cp -v /c/AppDev/maven-repo/commons-jelly/commons-jelly-tags-interaction/1.1/commons-jelly-tags-interaction-1.1.jar ~/.maven/repository/commons-jelly/jars
cp -v /c/AppDev/maven-repo/commons-jelly/commons-jelly-tags-jsl/1.0/commons-jelly-tags-jsl-1.0.jar ~/.maven/repository/commons-jelly/jars
cp -v /c/AppDev/maven-repo/commons-jelly/commons-jelly-tags-log/1.0/commons-jelly-tags-log-1.0.jar ~/.maven/repository/commons-jelly/jars
cp -v /c/AppDev/maven-repo/commons-jelly/commons-jelly-tags-velocity/1.0/commons-jelly-tags-velocity-1.0.jar ~/.maven/repository/commons-jelly/jars
cp -v /c/AppDev/maven-repo/commons-jelly/commons-jelly-tags-xml/1.1/commons-jelly-tags-xml-1.1.jar ~/.maven/repository/commons-jelly/jars
...
cp -v /c/AppDev/maven-repo/commons-jexl/commons-jexl/1.1/commons-jexl-1.1.jar ~/.maven/repository/commons-jexl/jars
...
mkdir -pv ~/.maven/repository/commons-lang/jars
cp -v /c/AppDev/maven-repo/commons-lang/commons-lang/2.0/commons-lang-2.0.jar ~/.maven/repository/commons-lang/jars
...
cp -v /c/AppDev/maven-repo/dom4j/dom4j/1.4/dom4j-1.4.jar ~/.maven/repository/dom4j/jars
...
cp -v /c/AppDev/maven-repo/fop/fop/0.20.5/fop-0.20.5.jar ~/.maven/repository/fop/jars
...
cp -v /c/AppDev/maven-repo/forehead/forehead/1.0-beta-5/forehead-1.0-beta-5.jar ~/.maven/repository/forehead/jars
...
cp -v /c/AppDev/maven-repo/javacc/javacc/3.2/javacc-3.2.jar ~/.maven/repository/javacc/jars
...
cp -v /c/AppDev/maven-repo/jaxen/jaxen/1.1-beta-9/jaxen-1.1-beta-9.jar ~/.maven/repository/jaxen/jars
...
cp -v /c/AppDev/maven-repo/jdom/jdom/1.0/jdom-1.0.jar ~/.maven/repository/jdom/jars
...
cp -v /c/AppDev/maven-repo/jline/jline/0.9.5/jline-0.9.5.jar ~/.maven/repository/jline/jars
...
cp -v /c/AppDev/maven-repo/log4j/log4j/1.2.13/log4j-1.2.13.jar ~/.maven/repository/log4j/jars
...
cp -v /c/AppDev/maven-repo/maven/commons-jelly/1.0.1-20060717/commons-jelly-1.0.1-20060717.jar ~/.maven/repository/maven/jars
cp -v /c/AppDev/maven-repo/maven/dom4j/1.7-20060614/dom4j-1.7-20060614.jar ~/.maven/repository/maven/jars
cp -v /c/AppDev/maven-repo/maven/maven-model/3.0.2/maven-model-3.0.2.jar ~/.maven/repository/maven/jars
...
cp -v /c/AppDev/maven-repo/msv/msv/20050913/msv-20050913.jar ~/.maven/repository/msv/jars
cp -v /c/AppDev/maven-repo/msv/isorelax/20050913/isorelax-20050913.jar ~/.maven/repository/msv/jars
cp -v /c/AppDev/maven-repo/msv/relaxngDatatype/20050913/relaxngDatatype-20050913.jar ~/.maven/repository/msv/jars
cp -v /c/AppDev/maven-repo/msv/xsdlib/20050913/xsdlib-20050913.jar ~/.maven/repository/msv/jars
...
cp -v /c/AppDev/maven-repo/nekohtml/nekohtml/0.7.7/nekohtml-0.7.7.jar ~/.maven/repository/nekohtml/jars
...
cp -v /c/AppDev/maven-repo/net/java/dev/stax-utils/stax-utils/20060502/stax-utils-20060502.jar ~/.maven/repository/net.java.dev.stax-utils/jars
...
cp -v /c/AppDev/maven-repo/org/apache/maven/maven-jxr/1.0/maven-jxr-1.0.jar ~/.maven/repository/org.apache.maven/jars
...
cp -v /c/AppDev/maven-repo/org/apache/maven/scm/maven-scm-api/1.0-beta-2/maven-scm-api-1.0-beta-2.jar ~/.maven/repository/org.apache.maven.scm/jars
cp -v /c/AppDev/maven-repo/org/apache/maven/scm/maven-scm-provider-clearcase/1.0-beta-2/maven-scm-provider-clearcase-1.0-beta-2.jar ~/.maven/repository/org.apache.maven.scm/jars
cp -v /c/AppDev/maven-repo/org/apache/maven/scm/maven-scm-provider-cvs/1.0-beta-2/maven-scm-provider-cvs-1.0-beta-2.jar ~/.maven/repository/org.apache.maven.scm/jars
cp -v /c/AppDev/maven-repo/org/apache/maven/scm/maven-scm-provider-perforce/1.0-beta-2/maven-scm-provider-perforce-1.0-beta-2.jar ~/.maven/repository/org.apache.maven.scm/jars
cp -v /c/AppDev/maven-repo/org/apache/maven/scm/maven-scm-provider-starteam/1.0-beta-2/maven-scm-provider-starteam-1.0-beta-2.jar ~/.maven/repository/org.apache.maven.scm/jars
cp -v /c/AppDev/maven-repo/org/apache/maven/scm/maven-scm-provider-svn/1.0-beta-2/maven-scm-provider-svn-1.0-beta-2.jar ~/.maven/repository/org.apache.maven.scm/jars
...
cp -v /c/AppDev/maven-repo/org/apache/maven/wagon/wagon-file/1.0-beta-2/wagon-file-1.0-beta-2.jar ~/.maven/repository/org.apache.maven.wagon/jars
cp -v /c/AppDev/maven-repo/org/apache/maven/wagon/wagon-ftp/1.0-beta-2/wagon-ftp-1.0-beta-2.jar ~/.maven/repository/org.apache.maven.wagon/jars
cp -v /c/AppDev/maven-repo/org/apache/maven/wagon/wagon-http/1.0-beta-2/wagon-http-1.0-beta-2.jar ~/.maven/repository/org.apache.maven.wagon/jars
cp -v /c/AppDev/maven-repo/org/apache/maven/wagon/wagon-provider-api/1.0-beta-2/wagon-provider-api-1.0-beta-2.jar ~/.maven/repository/org.apache.maven.wagon/jars
cp -v /c/AppDev/maven-repo/org/apache/maven/wagon/wagon-ssh/1.0-beta-2/wagon-ssh-1.0-beta-2.jar ~/.maven/repository/org.apache.maven.wagon/jars
cp -v /c/AppDev/maven-repo/org/apache/maven/wagon/wagon-ssh-common/1.0-beta-2/wagon-ssh-common-1.0-beta-2.jar ~/.maven/repository/org.apache.maven.wagon/jars
cp -v /c/AppDev/maven-repo/org/apache/maven/wagon/wagon-ssh-external/1.0-beta-2/wagon-ssh-external-1.0-beta-2.jar ~/.maven/repository/org.apache.maven.wagon/jars
...
cp -v /c/AppDev/maven-repo/org/apache/velocity/velocity/1.5/velocity-1.5.jar ~/.maven/repository/org.apache.velocity/jars
...
cp -v /c/AppDev/maven-repo/oro/oro/2.0.8/oro-2.0.8.jar ~/.maven/repository/oro/jars
...
cp -v /c/AppDev/maven-repo/org/codehaus/plexus/plexus-utils/1.0.5/plexus-utils-1.0.5.jar ~/.maven/repository/org.codehaus.plexus/jars
...
cp -v /c/AppDev/maven-repo/plexus/plexus-utils/1.0.3/plexus-utils-1.0.3.jar ~/.maven/repository/plexus/jars
...
cp -v /c/AppDev/maven-repo/pmd/pmd/3.9/pmd-3.9.jar ~/.maven/repository/pmd/jars
...
cp -v /c/AppDev/maven-repo/stax/stax/1.2.0/stax-1.2.0.jar ~/.maven/repository/stax/jars
cp -v /c/AppDev/maven-repo/stax/stax-api/1.0.1/stax-api-1.0.1.jar ~/.maven/repository/stax/jars
...
cp -v /c/AppDev/maven-repo/vdoclet/qdox/current/qdox-current.jar ~/.maven/repository/vdoclet/jars
cp -v /c/AppDev/maven-repo/vdoclet/vdoclet/20020711/vdoclet-20020711.jar ~/.maven/repository/vdoclet/jars
...
cp -v /c/AppDev/maven-repo/velocity/velocity/1.4/velocity-1.4.jar ~/.maven/repository/velocity/jars
...
cp -v /c/AppDev/maven-repo/velocity-dvsl/velocity-dvsl/0.45/velocity-dvsl-0.45.jar ~/.maven/repository/velocity-dvsl/jars
...
cp -v /c/AppDev/maven-repo/xalan/xalan/2.7.0/xalan-2.7.0.jar ~/.maven/repository/xalan/jars
...
cp -v /c/AppDev/maven-repo/xerces/xercesImpl/2.6.2/xercesImpl-2.6.2.jar ~/.maven/repository/xerces/jars
cp -v /c/AppDev/maven-repo/xerces/xercesImpl/2.8.0/xercesImpl-2.8.0.jar ~/.maven/repository/xerces/jars
cp -v /c/AppDev/maven-repo/xerces/xmlParserAPIs/2.6.2/xmlParserAPIs-2.6.2.jar ~/.maven/repository/xerces/jars
...
cp -v /c/AppDev/maven-repo/xml-apis/xml-apis/1.3.03/xml-apis-1.3.03.jar ~/.maven/repository/xml-apis/jars
...
cp -v /c/AppDev/maven-repo/xml-resolver/xml-resolver/1.1/xml-resolver-1.1.jar ~/.maven/repository/xml-resolver/jars
